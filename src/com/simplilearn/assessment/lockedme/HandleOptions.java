	...
	public static void handleWelcomeScreenInput() {
		...
		do {
			try {
				...
				case 1: FileOperations.displayAllFiles("MainDirectory");
						break;
						
				case 2: HandleOptions.handleFileMenuOptions();
						break;
	...
	public static void handleFileMenuOptions() {
		...
		do {
			try {
				...
				switch (input) {
				// File Add
				case 1: System.out.println("Enter the name of the file to be added to the \"MainDirectory\" folder");
				...
				// File/Folder delete	
				case 2: System.out.println("Enter the name of the file to be deleted from \"MainDirectory\" folder");
						String fileToDelete = sc.next();
						
						FileOperations.createMainFolderIfNotPresent("MainDirectory");
						List<String> filesToDelete = FileOperations.displayFileLocations(fileToDelete, "MainDirectory");
				...
				// File/Folder Search		
				case 3: System.out.println("Enter the name of the file to be searched from \"MainDirectory\" folder");
						String fileName = sc.next();
						
						FileOperations.createMainFolderIfNotPresent("MainDirectory");
						FileOperations.displayFileLocations(fileName, "MainDirectory");
						break;
